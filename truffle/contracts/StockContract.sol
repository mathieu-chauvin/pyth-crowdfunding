...
contract StockContract {
    ...
    mapping (bytes12 => mapping(address => uint256)) public _stakes;


    //  idOfObject => pythHolderAddress => value
    mapping (bytes12 => uint256) public _totalStakes;
    ...
    function addStake(bytes12 idProject, uint256 amount) public returns (bool) {
    ...
    function removeStake(bytes12 idProject, uint256 amount) public returns (bool) {
    ...
    function getReward(bytes12 idProject) public returns (bool) {
